    ...
    User.findOne({ email })
      .then((user) => {
        ...
        <table class="es-wrapper" width="100%" cellspacing="0" cellpadding="0">
          ...
          .catch((saveError) => {
            console.error("Error saving user reset token:", saveError);
            res.status(500).json({ error: "Internal Server Error" });
          });
      })
      .catch((findError) => {
